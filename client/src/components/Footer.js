  ...
  return (
    <footer className="bg-slate-900 pt-16 pb-8">
      <div className="container-custom px-6">
        {/* Top Section */}
        <div className="grid md:grid-cols-3 gap-8 pb-12 border-b border-slate-800">
          {/* Brand */}
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center">
                <span className="text-white font-heading font-bold text-xl">JP</span>
              </div>
              <span className="text-white font-heading font-bold text-xl">Jalel Prince</span>
            </div>
            <p className="text-slate-400 leading-relaxed">
              Virtual Assistant & Web Developer helping businesses streamline operations and build digital presence.
            </p>
          </div>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-slate-500 text-sm">
            © {currentYear} Jalel Prince G. Gayo. All rights reserved.
          </p>
